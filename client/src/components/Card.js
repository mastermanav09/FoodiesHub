    ...
    <div className='shadow-lg p-3 mb-5 bg-white rounded'>
      ...
      <div className='flex-container'>
        <div className='w-100 m-1'>
          <p>Variant</p>
          <select value={Variant} onChange={(e) =>  setVariant(e.target.value) } className='form-control'>
      ...
      <div className='flex-container'>
        ...
        <div className='m-1 w-100'><button className='btn' onClick={addtoCart}> Add to cart</button></div>
      </div>
      <Modal show={show}>
        <Modal.Header>
        ...
        <Modal.Body>
          <img className='img-fluid' src={food.image} alt='' style={{height: '400px',borderRadius : '10px'}}/>
